...
const EditCategorizerCard = ({ title, tagColor, onDone, onCancel,  onDelete }) =>
{
        ...
        <AnimatePresence mode="wait">
                ...
                <motion.div
                    ...
                    <div className="p-6 flex flex-col gap-6">
                        ...
                        <div className="flex justify-between">
                            <button
                                className="bg-red-500 text-white py-2 px-6 rounded-md hover:bg-red-700 transition-all duration-200 hover:scale-110"
                                onClick={onCancel}>
                                Cancel
                            </button>
                            <button
                                className="bg-blue-500 text-white py-2 px-6 rounded-md hover:bg-blue-700 transition-all duration-200 hover:scale-110"
            ...
            {showDeleteConfirm && (
                <div className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 60 }}>
                    ...
                    <motion.div
                        className="bg-white rounded-md w-80 p-6 flex flex-col gap-4 shadow-xl relative z-10"
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-500">
                                Are you sure you want to delete the category "{title}"? This action cannot be undone.
                            </p>
                        </div>
                        <div className="flex justify-between mt-2">
                            <button
                                className="bg-gray-200 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-300 transition-colors duration-200 w-36"
                                onClick={handleCancelDelete}>
                                Cancel
                            </button>
                            <button
                                className="bg-red-500 text-white py-2 px-4 rounded-md hover:bg-red-700 transition-colors duration-200 w-36"
