    ...
    return(
        <div className="relative">
            <div className="bg-gray-100 rounded-lg shadow-md p-2 flex flex-col w-64">
                <div className="p-3 rounded-md flex justify-between items-center" style={{ backgroundColor: editableTagColor, color: textColor }}>
                    <span className="w-full text-left">{editableTitle}</span>
                    <Settings size={18} cursor="pointer" onClick={() => setIsEditing(true)} 
                ...
                <button
                    onClick={addEntry}
                    className="mt-2 bg-blue-500 text-white py-2 px-4 rounded-md flex items-center justify-center gap-1 transition-transform transform hover:bg-blue-600 hover:scale-105">
