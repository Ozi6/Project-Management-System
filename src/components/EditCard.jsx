            ...
            <div className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 70 }}>
                <motion.div
                    ...
                    <div className="bg-[var(--features-icon-color)] p-3 rounded-t-xl">
                        <h3 className="text-xl font-bold text-white text-center">{t("prode.edit.task")}</h3>
                    </div>
                    <div className="flex">
                        <div className="flex-1 p-4 flex flex-col justify-between">
                            <div className="space-y-2">
                                <div>
                                    <label className="text-sm font-medium text-[var(--features-title-color)]">{t("prode.e")}</label>
                                    <input
                                        type="text"
                                        value={editedTitle}
                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-medium text-gray-900">Delete Task List</h3>
