  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="w-full bg-white shadow-sm z-10">
        <Header
          title={<span className="text-xl font-semibold text-gray-800">Admin - User Issues</span>}
        />
      </div>
                        ...
                        >
                          <td className="py-3 px-4">
                            <div>
                              ...
                              <p className="text-sm text-gray-500 truncate max-w-[250px]">{issue.description}</p>
                            </div>
                          </td>
                          <td className="py-3 px-4">
