...
import
{
    ...
    FaTrash, FaPencilAlt, FaPlus, FaThumbtack, FaRegStickyNote
} from "react-icons/fa";
import
{
...
const Notes = () => {
    ...
    const [editNoteData, setEditNoteData] = useState({ id: null, title: "", content: "", isPinned: false, isShared: false });
                                            ...
                                            .map((note) => (
                                                <div
                                                    ...
                                                    <div className="p-5">
                                                        ...
                                                        <div className="mt-3 mb-4 text-gray-600 text-sm h-24 overflow-hidden">
                                                            {note.content}
                                                        </div>
